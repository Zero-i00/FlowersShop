...
plusMinusWidgets2 = document.querySelectorAll(".f-counter");
...
for (var j = 0; j < plusMinusWidgets2.length; j++) {
  plusMinusWidgets2[j].querySelector(".minusBtn").addEventListener("click", clickHandler);
  plusMinusWidgets2[j].querySelector(".plusBtn").addEventListener("click", clickHandler);
  plusMinusWidgets2[j].querySelector(".count").addEventListener("change", changeHandler);
}
